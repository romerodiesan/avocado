              ...
              <figure>
                ...
                <figcaption className="space-y-3">
                  ...
                  <section className="space-y-1 w-72 md:w-96">
                    <p className="truncate"><span className="font-semibold">Description: </span> {product?.description}</p>
                    <p className="truncate"><span className="font-semibold">Hardiness: </span> {product?.hardiness}</p>
