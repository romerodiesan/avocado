const data: Record<TProductId, TProduct> = {
  '2zd33b8c': {
    ...
    sku: 'NUR72KCM',
    price: 1.15,
    image: 'https://static.platzi.com/media/tmp/class-files/github/platzi-nextjs/platzi-nextjs-3-api/public/images/maluma.jpg',
    attributes: {
      description:
  ...
  '6trfgkkj': {
    ...
    sku: 'AX4M8SJV',
    price: 1.21,
    image: 'https://static.platzi.com/media/tmp/class-files/github/platzi-nextjs/platzi-nextjs-3-api/public/images/fuerte.jpg',
    attributes: {
      description:
  ...
  '7bcr49em': {
    ...
    sku: 'HYA78F6J',
    price: 1.25,
    image: 'https://static.platzi.com/media/tmp/class-files/github/platzi-nextjs/platzi-nextjs-3-api/public/images/gwen.jpg',
    attributes: {
      description:
  ...
  '098323ks': {
    ...
    sku: 'BXD100BLK',
    price: 1.51,
    image: 'https://static.platzi.com/media/tmp/class-files/github/platzi-nextjs/platzi-nextjs-3-api/public/images/bacon.jpg',
    attributes: {
      description:
  ...
  b8uthe2y: {
    ...
    sku: 'RMRCZN7E',
    price: 1.39,
    image: 'https://static.platzi.com/media/tmp/class-files/github/platzi-nextjs/platzi-nextjs-3-api/public/images/hass.jpg',
    attributes: {
      description:
  ...
  ewxsd6xb: {
    ...
    sku: 'N55229ZA',
    price: 1.34,
    image: 'https://static.platzi.com/media/tmp/class-files/github/platzi-nextjs/platzi-nextjs-3-api/public/images/lamb.jpg',
    attributes: {
      description:
  ...
  fpr72m9k: {
    ...
    sku: 'B4HZ42TM',
    price: 1.27,
    image: 'https://static.platzi.com/media/tmp/class-files/github/platzi-nextjs/platzi-nextjs-3-api/public/images/pinkerton.jpg',
    attributes: {
      description:
  ...
  t9dv25gs: {
    ...
    sku: 'ZY3T9XXC',
    price: 1.18,
    image: 'https://static.platzi.com/media/tmp/class-files/github/platzi-nextjs/platzi-nextjs-3-api/public/images/reed.jpg',
    attributes: {
      description:
  ...
  t345w48y: {
    ...
    sku: 'MW79ZZ6Y',
    price: 1.25,
    image: 'https://static.platzi.com/media/tmp/class-files/github/platzi-nextjs/platzi-nextjs-3-api/public/images/zutano.jpg',
    attributes: {
      description:
